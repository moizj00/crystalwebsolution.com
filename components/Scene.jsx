...
const SceneContent = memo(function SceneContent({ quality, mountCarousel }) {
  return (
    <>
...
export default function Scene() {
  ...
  const camera = useMemo(
    () => ({ fov: 42, near: 0.1, far: 260, position: [0, 0.25, 7.5] }),
    []
  );
    ...
    <div className="scene-canvas" aria-hidden="true">
      ...
      >
        <Suspense fallback={null}>
          <SceneContent quality={quality} mountCarousel={mountCarousel} />
        </Suspense>
      </Canvas>
    </div>
  );
