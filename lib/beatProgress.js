...
// anything windowed against a specific beat, like MarkAssembly's shard
// burst) stays locked to the section actually on screen, however long
// any one section's content grows or shrinks.
//
...
export const BEAT_IDS = ['hero', 'services', 'approach', 'work', 'stories', 'mark', 'about', 'facts', 'recognition', 'motion', 'contact'];
...
// (CameraRig's segment lookup, MarkAssembly's window) goes stale.
